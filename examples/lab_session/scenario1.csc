...
<simconf>
  ...
  <simulation>
    ...
    <radiomedium>
      ...
      <transmitting_range>61.0</transmitting_range>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/lab_session/node/node.c</source>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype518</identifier>
      <description>Interferer</description>
      <source>[CONTIKI_DIR]/examples/lab_session/interferer/interferer.c</source>
      <commands>make interferer.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.690709410909089 0.0 0.0 4.690709410909089 51.36087165672732 164.578399232</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
